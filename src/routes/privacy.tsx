...
export const Route = createFileRoute("/privacy")({
  head: () =>
    buildMeta({
      ...
      description:
        "How Octapus L.L.C. collects, uses and protects information gathered through this website and related services.",
      path: "/privacy",
      ogType: "article",
    }),
      ...
      <Section eyebrow="Legal" title="Privacy Policy">
        <div className="mx-auto max-w-3xl prose prose-neutral text-muted-foreground space-y-4">
          <p>
            ...
            collected through this website and related services.
          </p>
        </div>
      </Section>
    </>
