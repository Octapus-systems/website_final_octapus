...
const defaultItems: TimelineItem[] = [
  {
    ...
    detail: "Octapus map your current systems, gaps and priorities in one focused session.",
  },
  {
    label: "Week 1",
    title: "Blueprint",
    detail: "Scope, architecture and a fixed delivery plan you can sign off on.",
  },
  {
    label: "Weeks 2–4",
    title: "Design & build",
    detail: "Interfaces, data model and core workflows built in weekly increments.",
  },
  {
    label: "Week 5",
    title: "Integrate",
    detail: "Your tools connect through OIS so operations run from one layer.",
  },
  {
    label: "Week 6",
    title: "Launch",
    detail: "Go live with training, documentation and monitoring in place.",
  },
  {
    label: "Ongoing",
    title: "Scale",
    detail: "Continuous improvement, new modules and AI automation as you grow.",
  },
];
